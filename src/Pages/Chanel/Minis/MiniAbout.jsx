        ...
        <section className="All">
            ...
            <div className="All-Box5">
                ...
                <div className="about">
                  ...
                  <div id="video">
                    <span className="playlist">About:</span>
                    <h1 id="video-title"><span id="video-title-about">Assalomu alaykum!
                    Najot Ta’lim – qisqa vaqt ichida yuqori natijalarga erishgan, O’zbekistondagi zamonaviy kasblarni <br /> o’rgatuvchi ilg’or o’quv markazi. Sizga eng kerakli zamonaviy kasb va bilimlarni o’rgatadigan maskan. <br /> Bu yerda xorijiy tillar hamda SMM, digital marketing, grafik dizayn, <br /> moushn grafika va dasturlash kabi zamonaviy kasblarning mutaxassisi bo’lishingiz mumkin.</span></h1>
                  </div>

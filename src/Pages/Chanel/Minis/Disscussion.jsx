            ...
            <div className="All-Box5">
                ...
                <div className="about">
                  ...
                  <iframe id='video-img' width="450" height="250" src="https://www.youtube.com/embed/2kiAV2K72Cc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <Link id="video-title" to='video'>Frontend'ni o'rganish uchun <br /> Foundation nega kerak? <br /> <span id="video-title-about">Nega Frontend kursini bootcamp tarzida o'qimoqchi <br /> bo'lgan o'quvchilarga ham avvalo Foundation'da o'qish <br /> maslahat berilmoqda?</span> <br /> <span id="video-title-date">2 831 просмотр1 мая 2021 г.</span> </Link>
                  </div>
                  <div className="users">

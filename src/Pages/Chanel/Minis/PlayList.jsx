        ...
        <section className="All">
            ...
            <div className="All-Box5">
                ...
                <div className="about">
                  ...
                  <div id="video">
                    <span className="playlist">PlayLists:</span>
                    <h1 id="video-title">Hammasi Najot Ta'limdan boshlanadi! <br /> Web Dasturlash <br /> #TAQDIMOT <br /> MeetUp <br /> Bu nima o'zi?</h1>
                  </div>
                  <div className="playusers">
